class BookingPaymentsController < ApllicationController
  def create
    ...
    action: "success",
    only_path: false,
    booking_params: booking_payments_params.expect(:stripeToken)
    )
  ...
  def success
    ...
    reservation = Reservation.create!(
      ...
      checkin_data: booking_params[:checkin_data],

...
ActiveRecord::Schema[8.0].define(version: 2026_01_03_142135) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.index ["user_id", "property_id", "checkin_data", "checkout_date"], name: "add_index_to_reservations", unique: true
    t.index ["user_id", "property_id", "checkin_data", "checkout_date"], name: "idx_on_user_id_property_id_checkin_data_checkout_da_a321ff7d48", unique: true
